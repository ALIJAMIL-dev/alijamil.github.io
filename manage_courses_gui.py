#!/usr/bin/env python3
"""
manage_courses_gui.py

Simple Tkinter GUI to add/edit courses for the learning backend.
Writes to backend/flaskr/data/courses.json and creates lessons_<id>.json

Run:
  python manage_courses_gui.py
"""
import os
import json
