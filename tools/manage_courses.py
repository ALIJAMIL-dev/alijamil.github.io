#!/usr/bin/env python3
"""
tools/manage_courses.py

CLI to add courses and lessons to backend/flaskr/data.
Usage (PowerShell):
  python tools\manage_courses.py --add --title "Course Title" --lessons 12 --videos video1.mp4,video2.mp4
...
# REPO root is parent of tools folder
